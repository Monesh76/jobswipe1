    ...
    return (
      <div className="container mx-auto p-4 text-center">
        ...
        <Link 
          ...
          className="px-4 py-2 bg-cyan-700 text-white rounded hover:bg-primary/90"
        >
          Add a Restaurant
        </Link>
      </div>
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link 
          href="/partner/add-new-restaurant" 
          className="px-3 py-1 bg-black text-white rounded text-sm hover:bg-primary cursor-pointer"
        ...
        {restaurants.map((restaurant) => (
          <div key={restaurant.restaurant_id} className="border rounded-lg overflow-hidden shadow-md flex flex-col">
            <div className="p-4 flex-grow">
              <h2 className="text-primary text-xl font-semibold mb-2">{restaurant.name}</h2>
              <p className="text-white-700 mb-2">{restaurant.description}</p>
              ...
              <p className="text-sm text-white-600 mb-4">{restaurant.contact_info}</p>
            ...
            <div className="mt-auto p-4 pt-0   gap-2 flex justify-end align-middle">
              ...
              <Link 
                ...
                className="px-3 py-1 bg-cyan-800 text-white text-black rounded text-sm hover:bg-primary/90 hover:text-black"
              >
                View Details
              </Link>
            </div>
